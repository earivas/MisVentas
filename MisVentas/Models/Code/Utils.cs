...
namespace MisVentas.Models.Code
{
    ...
    public static class Utils
    {
        ...
        static readonly Dictionary<DemoPageModel, IEnumerable<SourceCodePage>> sourceCodeCache = new Dictionary<DemoPageModel, IEnumerable<SourceCodePage>>();
        ...
        public static bool IsMvc
        {
            get
            {
                return SitesModel.Current.IsMvc;
            }
        }
        ...
        public static DemoPageModel CurrentDemo
        {
            get
            {
                return (DemoPageModel)Context.Items[CurrentDemoKey];
            }
        }
        public static DemoProductModel RootProduct
        {
            get
            {
                return SitesModel.Instance.SortedDemoProducts.Find(p => p.IsRootDemo);
            }
        }
        ...
        static void RegisterCurrentDemo(string groupKey, string demoKey)
        {
            ...
            if (IsIntroPage(groupKey, demoKey))
                demo = SitesModel.Current.Intro;
            else if (IsOverviewPage(demoKey) && String.IsNullOrEmpty(groupKey))
                demo = SitesModel.Current.Overview;
            ...
            {
                SiteGroupModel group = SitesModel.Current.FindGroup(groupKey);
                if (group != null)
            ...
            DevExpress.Web.Internal.DemoUtils.RegisterDemo(SitesModel.Current.Key, groupKey, demoKey);
        }

        static DemoPageModel CreateBogusDemoModel()
        {
            SiteGroupModel group = new SiteGroupModel();
            group.Title = "ASP.NET";
        ...
        static DemoPageModel CreateErrorPageDemoModel()
        {
            ...
            {
                IsErrorPage = true,
                Product = SitesModel.Current,
                Group = new SiteGroupModel()
            };
            return result;
        }
        ...
        public static string GetCurrentDemoPageTitle()
        {
            ...
            if (CurrentDemo.IsErrorPage)
            {
                ...
                builder.Append(SitesModel.Current.GetSeoTitle());
                if (!SitesModel.Current.IsRootDemo)
                    builder.Append(" Demo");
            }
            ...
            {
                string product = SitesModel.Current.GetSeoTitle();
                SiteGroupModel demoGroup = ((DemoPageModel)CurrentDemo).Group;
        ...
        public static string GenerateDemoUrl(DemoModel demo)
        {
            ...
            SiteGroupModel demoGroup = demo is DemoPageModel ? ((DemoPageModel)demo).Group : null;
        ...
        public static List<FeaturedDemoInfo> GenerateFeaturedDemos()
        {
            ...
            foreach (var demo in SitesModel.Current.HighlightedDemos)
            {
        ...
        public static List<ProductInfo> GenerateProductDemos(bool highlited)
        {
            ...
            foreach (var item in SitesModel.Instance.SortedDemoProducts.Where(p => !p.HideNavItem && !p.IsRootDemo && p.IntegrationHighlighted == highlited))
            {
        ...
        public static string GetReadOnlyMessageHtml()
        {
            return String.Format(
                ...
                "{0} on your machine and run the demo locally.", SitesModel.Current.Title);
        }
        ...
        public static bool CanChangeTheme
        {
            get
            {
                return !IsIntro && !IsIE6() && SitesModel.Current.SupportsTheming;
            }
        }
        ...
        public static bool CanApplyThemeParameters
        {
            get
            {
                return SitesModel.Current.SupportsThemeParameters && (!string.IsNullOrEmpty(CurrentThemeDefaultFont) || !string.IsNullOrEmpty(CurrentThemeDefaultBaseColor));
            }
        }
        ...
        {
            if (!CanChangeTheme || !SitesModel.Current.SupportsThemeParameters)
                return;
    ...
    public static class SearchUtils
    {
        ...
        static string[] WordsExclusions
        {
            get
            {
                if (_requestExclusions == null)
                    _requestExclusions = SitesModel.Instance.Search.Exclusions.Words.Split(separators, StringSplitOptions.RemoveEmptyEntries);
        ...
        static string[] PrefixesExclusions
        {
            ...
            {
                if (_prefixes == null)
                    _prefixes = SitesModel.Instance.Search.Exclusions.Prefixes.Split(separators, StringSplitOptions.RemoveEmptyEntries);
                return _prefixes;
            }
        }
        static string[] PostfixesExclusions
        {
            ...
            {
                if (_postfixes == null)
                    _postfixes = SitesModel.Instance.Search.Exclusions.Postfixes.Split(separators, StringSplitOptions.RemoveEmptyEntries);
                return _postfixes;
            }
        }
        static string[][] Synonyms
        {
            ...
            {
                if (_synonyms == null)
                    _synonyms = SitesModel.Instance.Search.Synonyms.Groups.Select(s => s.Split(separators, StringSplitOptions.RemoveEmptyEntries)).ToArray();
                return _synonyms;
            }
        }
        ...
        public static List<SearchResult> DoSearch(string request)
        {
            ...
            if (!string.IsNullOrEmpty(request))
            {
                ...
                try
                {
                    var products = SitesModel.Instance.SortedDemoProducts.Where(dp => !dp.IsRootDemo && (dp == SitesModel.Current || (!dp.HideNavItem && Utils.IsSiteMode)));
        ...
        public static Dictionary<string, int> GetKeywordsRankList(ModelBase model)
        {
            ...
            var group = model as SiteGroupModel;
