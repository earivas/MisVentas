...
namespace MisVentas.Models.Code
{
    ...
    public class SitesModel
    {
        ...
        public static SitesModel Instance
        {
            get
            {
                lock (_instanceLock)
                {
                    if (_instance == null)
                    {
                        ...
                        {
                            XmlSerializer serializer = new XmlSerializer(typeof(SitesModel));
                            _instance = (SitesModel)serializer.Deserialize(stream);
                        }
    ...
    public class DemoProductModel : ModelBase
    {
        ...
        List<SiteGroupModel> _groups = new List<SiteGroupModel>();
        ...
        public List<SiteGroupModel> Groups
        {
            get { return _groups; }
        }
       ...
       [XmlIgnore]
        ...
        {
            get { return this == SitesModel.Current; }
        }

        public SiteGroupModel FindGroup(string key)
        {
            key = key.ToLower();
            foreach (SiteGroupModel group in Groups)
            {
